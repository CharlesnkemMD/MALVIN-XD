...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "malvin~QuVUWTrK#5kwy2O_ySpJdtMcwmWVI7D4bd5rf4ufKj39lqqRgh0M",
// add your Session Id make sure it starts with malvin~
PREFIX: process.env.PREFIX || ".",
// add your prifix for bot   
BOT_NAME: process.env.BOT_NAME || "CHARLESMD",
...
// make true if you want auto reply on status 
        ...
        AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*SEEN YOUR STATUS BY CHARLES MD 😆*",
...
// automatic delete links witho remove member 
          ...
          OWNER_NUMBER: process.env.OWNER_NUMBER || "2349011876086",
// add your bot owner number

OWNER_NAME: process.env.OWNER_NAME || "LUCIFER MORNINGSTAR 😈",
// add bot owner name
...
// true if want mark commands as read 
     ...
     DEV: process.env.DEV || "2349011876086",
